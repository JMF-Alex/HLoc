...
public class CommentsPane {
    ...
    public CommentsPane() {
        ...
        table.getColumns().addAll(idCol, routeCol, commentCol, ratingCol, dateCol, actionsCol);
    ...
    public static void setItems() {
        table.setItems(CommentsDAO.getCommentsByUserId(CurrentUserModel.getUser().getId()));
    }
