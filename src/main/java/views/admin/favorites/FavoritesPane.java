...
public class FavoritesPane {
    ...
    public FavoritesPane() {
        ...
        TableColumn<FavoritesModel, Integer> userCol = new TableColumn<>("Usuario ID");
        ...
        table.getColumns().addAll(idCol, userCol, routeCol, dateCol, actionsCol);

        setItems();

        refreshButton.setOnAction(e -> setItems());
        addButton.setOnAction(e -> AddFavoritesPane.openAdder());

        root.getChildren().addAll(header, table);
    }

    public static void setItems() {
        table.setItems(FavoritesDAO.getAllFavorites());
    }
