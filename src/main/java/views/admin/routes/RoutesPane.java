...
public class RoutesPane {
    ...
    public RoutesPane() {
        ...
        TableColumn<RoutesModel, Integer> idCol = new TableColumn<>("ID");
        idCol.setCellValueFactory(c -> c.getValue().idProperty().asObject());

        TableColumn<RoutesModel, Integer> userIdCol = new TableColumn<>("User ID");
        userIdCol.setCellValueFactory(c -> c.getValue().userIdProperty().asObject());
        ...
        table.getColumns().addAll(idCol, userIdCol, titleCol, difficultyCol, visibilityCol, publicationCol, actionsCol);
    ...
    public static void setItems() {
        table.setItems(RoutesDAO.getAllRoutes());
    }
